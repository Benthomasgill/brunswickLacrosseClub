<div class="nav-container">
    <div class="header-container">
        <div class="header-titles">
            <a href="/"><img class="nav-logo <?php if(wp_is_mobile()) { ?>site-logo-mobile<?php } ?>" alt="<?php echo get_bloginfo( 'name' ); ?>" src="<?php echo get_template_directory_uri(); ?>/images/logos/logo.png"></a>
        </div>
