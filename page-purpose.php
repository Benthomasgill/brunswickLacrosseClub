        ...
        <div class="container">
            <div class="ct-flex">
                ...
                <div class="ct-50 ct-float-text">
                    ...
                    We encourage children and adults to be part of a sporting community through playing lacrosse. We are committed to engaging with local schools and the community to expand the club locally. We strive to create an environment that allows players to reach their playing potential and to have fun.</p>
                </div>
            </div>
        </div>
    </div>
